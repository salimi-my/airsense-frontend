/*
 * CUSTOMIZATIONS MADE TO STANDARD SHADCN SIDEBAR COMPONENT:
 *
 * 1. Increased SIDEBAR_WIDTH from "16rem" to "18rem" for wider desktop sidebar
 * 2. Changed ring to border for floating variant
 *
 * Changes maintain full compatibility with standard shadcn Sidebar API while providing more space for content.
 */
...
// ORIGINAL: const SIDEBAR_WIDTH = "16rem";
// CUSTOM: Increased width from 16rem to 18rem for wider desktop sidebar
    ...
    >
      ...
      >
        <div
          ...
          // ORIGINAL: className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1"
          // CUSTOM: Changed to border instead of ring for floating variant
